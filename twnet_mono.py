...
tokenizer = Tokenizer()
tokenizer.fit_on_texts(de_train_texts + de_dev_texts + de_test_texts)
...
x_train = de_train_data
y_train = de_train_labels
x_val = de_dev_data
y_val = de_dev_labels
x_test = de_test_data
y_test = de_test_labels
...
print('sample de gold:', gold[:30])
print('sample de pred:', predicted[:30])
print('micro de:', f1_score(gold, predicted, average='micro'))
print('macro de:', f1_score(gold, predicted, average='macro'))
