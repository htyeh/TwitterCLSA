...
train_dir = './TWEETS/CLEAN/EN_CLARIN_imbalanced/train'
...
# model.add(layers.Embedding(num_embedding_vocab, EMBEDDING_DIM, weights=[embedding_matrix], trainable=True, input_length=MAXLEN))
...
es = EarlyStopping(monitor='val_loss', mode='auto', min_delta=0.5, patience=5, restore_best_weights=True, verbose=1)
